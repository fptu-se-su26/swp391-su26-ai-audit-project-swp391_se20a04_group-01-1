...
export default function Home() {
    ...
    // các state dùng cho việc điều hướng trên bản đồ
    ...
    // A. Lấy tọa độ GPS của người dùng hiện tại
    ...
    // B. Chọn điểm đến khi click lên bản đồ
    const handleMapClick = (event: any) => {
        const { lng, lat } = event.lngLat;
        setDestination({ lng, lat });
    };

    // C. Tự động gọi API tìm đường khi có đủ điểm đi (userLocation) và điểm đến (destination)
    useEffect(() => {
    ...
    // Dựng cấu trúc GeoJSON LineString từ danh sách các điểm tọa độ từ backend trả về
        ...
        <div className="w-full h-screen relative bg-slate-100 overflow-hidden font-sans select-none">
            ...
            <div className="absolute inset-0 z-0">
                <Map
                    ...
                    onClick={handleMapClick} // Thêm lắng nghe sự kiện click chọn đích đến
            ...
            <div className="absolute right-6 bottom-10 flex flex-col gap-3 z-10 pointer-events-none">
                ...
                <div className="group relative pointer-events-auto flex justify-end items-center">
                    ...
                    <button
                        onClick={handleGetCurrentLocation} //  Gắn sự kiện định vị vào đây
