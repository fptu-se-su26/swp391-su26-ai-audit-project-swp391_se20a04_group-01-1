...
export default function EventsSidebar({
    ...
    return (
        <div className={`w-80 bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden flex flex-col transition-all duration-300 animate-fade-up pointer-events-auto ${
            ...
            <div className="px-4 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-2 text-white">
                    ...
                    <span className="font-bold text-sm tracking-wide">Khám phá Sự kiện</span>
                </div>
                <button
                    onClick={onClose}
                    ...
                    filteredEvents.map((evt) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <ChevronRight size={14} className="text-slate-300 self-center group-hover:text-indigo-400 transition-colors shrink-0" />
                            </button>
                        );
                    })
                )}
