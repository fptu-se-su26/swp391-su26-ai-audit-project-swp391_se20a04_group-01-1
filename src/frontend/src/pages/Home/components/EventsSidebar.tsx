...
export default function EventsSidebar({
  ...
  return (
    <div
      className={`w-80 max-md:w-full max-md:fixed max-md:bottom-0 max-md:left-0 max-md:right-0 max-md:h-[50vh] max-md:max-h-[50vh] max-md:rounded-t-3xl max-md:rounded-b-none max-md:z-[450] max-md:border-t max-md:border-slate-200/80 max-md:shadow-[0_-8px_30px_rgba(0,0,0,0.12)] max-md:animate-none bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden flex flex-col transition-all duration-300 animate-fade-up pointer-events-auto ${
      ...
      <div className="flex-1 overflow-y-auto p-2.5 space-y-2 scrollbar-none bg-slate-50/20">
        ...
        {filteredEvents.length === 0 ? (
          ...
          filteredEvents.map((evt) => {
            ...
            const eventImage =
              resolveImageUrl(evt.thumbnail_url) ||
              resolveImageUrl(evt.banner_url);
