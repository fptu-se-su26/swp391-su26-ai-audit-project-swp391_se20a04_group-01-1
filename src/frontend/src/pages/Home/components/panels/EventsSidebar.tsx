...
import { EventData, getEventStatus } from "../../types/event";
      ...
      {/* Danh sách kết quả */}
        <div className="flex-1 overflow-y-auto p-2.5 space-y-2 scrollbar-none bg-slate-50/20">
          <div className="text-[10px] font-bold text-slate-400 pl-1 pb-1">
            {/* Sử dụng optional chaining để lấy length an toàn */}
            KẾT QUẢ ({filteredEvents?.length || 0})
          </div>

          {/* FIX LỖI CRASH: Thêm (filteredEvents || []) để đảm bảo luôn là mảng */}
